...
const handleForgotPassword = async () => {
  ...
  try {
    ...
    error.value = err.response?.data?.message || 'Falha ao enviar link de recuperação. Tente novamente.';
  } finally {
    loading.value = false;
  }
};
    ...
    <div class="auth-container">
      <div class="auth-card">
        ...
        <div v-else class="success-message">
          ...
          <p>Enviamos um link de recuperação de senha para <strong>{{ email }}</strong></p>
          <p class="helper-text">Se não encontrar o e-mail, verifique sua pasta de spam.</p>
        </div>
